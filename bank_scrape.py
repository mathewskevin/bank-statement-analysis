...
# enter password
user_name = config_database.BANK_USERNAME
user_pass = config_database.BANK_PASSWORD

# input variables
site_name = config_database.site_name # site name
...
profile_loc = config_database.profile_loc # web browser profile

credit_name = config_database.credit_name # credit account name
checking_name = config_database.checking_name # checking account name
savings_name = config_database.savings_name # savings account name
